...
public class MjpegServer extends SimpleServer {
    public final String TAG = "MjpegServer";
    ...
    protected void handleConnection(Socket socket) throws IOException {
        Reader reader = new InputStreamReader(socket.getInputStream(), "ASCII");        //以ascii码的形式获取输入数据
        ...
        OutputStream out = socket.getOutputStream();        //输出流管道
